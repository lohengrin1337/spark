...
decoupled, blissfully unaware of constructions like "routes" or "rentals".
...
class Scooter:
    ...
    It knows and stores nothing about routes or rentals, holds only the physical state.
    """
    ...
    """
    Progress scooter forward by one "tick" == one step in time == one UPDATE_INTERVAL, set in config,
    adjusting speed, status, and battery accordingly.
    """
